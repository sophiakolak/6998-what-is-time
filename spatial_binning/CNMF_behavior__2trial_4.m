...
aBin = zeros(1, nLap, nBin); %bin the speed data
    ...
    speed1Bin_4 = speed1Bin;
    save('speed1Bin_4', 'speed1Bin_4');
    
    speed2Bin_4 = speed2Bin;
    save('speed2Bin_4', 'speed2Bin_4'); 
    
    %computes mean speed across trials for each cell and both odor conditions
    speed1Mean = squeeze(mean(speed1Bin, 2));
    speed1Max = max(speed1Mean');
    speed1Mean = rdivide(speed1Mean, speed1Max');
    speed1Mean_4 = speed1Mean;
    save('speed1Mean_4', 'speed1Mean_4');
    speed2Mean = squeeze(mean(speed2Bin, 2));
    speed2Max = max(speed2Mean');
    speed2Mean = rdivide(speed2Mean, speed2Max');
    speed2Mean_4 = speed2Mean;
    save('speed2Mean_4', 'speed2Mean_4');
...
lickBin = zeros(1, nLap, nBin); %bin the lickrate data
    ...
    lick2Bin(:,:,1)=0;
     ...
     lick1Bin_4 = lick1Bin;
 save('lick1Bin_4', 'lick1Bin_4');
      
 lick2Bin_4 = lick2Bin;
 save('lick2Bin_4', 'lick2Bin_4');
    
    
    %computes mean lickrate across trials for each cell and both odor conditions
    lick1Mean = squeeze(mean(lick1Bin, 2));
    lick1Max = max(lick1Mean');
    lick1Mean = rdivide(lick1Mean, lick1Max');
    lick1Mean_4 = lick1Mean;
    save('lick1Mean_4', 'lick1Mean_4');
    lick2Mean = squeeze(mean(lick2Bin, 2));
    lick2Max = max(lick2Mean');
    lick2Mean = rdivide(lick2Mean, lick2Max');
    lick2Mean_4 = lick2Mean;
    save('lick2Mean_4', 'lick2Mean_4');
